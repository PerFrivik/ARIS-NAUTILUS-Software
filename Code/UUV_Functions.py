...
def set_target_depth(depth, boot):
    boot_time = boot
...
def set_target_attitude(roll, pitch, yaw, boot):
    boot_time = boot
...
def Starting_procedure(master_connection):
    ...
    set_target_depth(depth, boot_time)
    ...
    pitch = #value
    yaw = #value
    set_target_attitude(roll, pitch, yaw, boot_time)
